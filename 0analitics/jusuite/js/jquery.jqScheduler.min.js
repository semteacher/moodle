...
e.dialog({modal:!0,width:490,closeOnEscape:!1,position:{at:"center bottom",of:a.jqschedule.calendarid},title:a.jqschedule.locales.editCaption,close:function(){e.dialog("destroy");e.hide();e=null},buttons:d}).show();a(".ui-dialog").css({"font-size":"12px","z-index":1E6});return!1},eventAddDialog:function(b,d,c,e){var f=a(a.jqschedule.eventid);a("input,textarea,select",f).val("");d?a("#endtime, #starttime",f).hide():a("#endtime, #starttime",f).show();a("#all_day",f).attr("checked",d);setTimeout(function(){a("#description",
...
"z-index":1E6})},eventLoading:function(b){if(b){b=a(".calwrapper").width();var d=a(".calwrapper").height()+10;a("body").append('<div class="ui-widget-overlay" style="width:'+b+"px;height:"+d+'px;z-index: 1001;"></div>');a("#progresspar").show()}else a(".ui-widget-overlay").remove(),a("#progresspar").hide()},eventDrop:function(b,d,c,e,f){null==b.end&&(b.end=b.start);a.ajax({url:a.jqschedule.calendarurl,data:{oper:"moveEvent",event_id:b.id,start:b.start.getTime()/1E3,end:b.end.getTime()/1E3,all_day:e?
1:0},type:"post"})},eventResize:function(b,d,c,e,f,g,k){a.ajax({url:a.jqschedule.calendarurl,data:{oper:"resizeEvent",event_id:b.id,start:b.start.getTime()/1E3,end:b.end.getTime()/1E3},type:"post"})},eventRender:function(a,d,c){try{a.description&&d.tooltip({position:{my:"left bottom",at:"center top",offset:"-30 -10",of:d},content:function(c){return a.description}})}catch(e){}},changeCalendarUser:function(){var b=a("#caluser");b.dialog({modal:!0,width:400,title:a.jqschedule.locales.userCaption,close:function(){b.dialog("destroy");
b.hide();b=null},buttons:[{text:a.jqschedule.locales.bChange,click:function(){var d=a("#switchuser",this).val();a.ajax({url:a.jqschedule.calendarurl,data:{_user_id:d,oper:"switchUser"},type:"post",success:function(b,d){a(a.jqschedule.calendarid).fullCalendar("refetchEvents");a("#common_search").val("");a(".fnd-results").html("");a("#search_table").empty();var f=a("#switchuser option:selected");if(1>=f.length)a("#cal_user").html("<li>"+f.text()+"</li>");else{var g="";a.each(f,function(){g+="<li>"+
a(this).text()+"</li>"});a("#cal_user").html(g)}}});b.dialog("close")}},{text:a.jqschedule.locales.bCancel,click:function(){b.dialog("close")}}]}).show();a(".ui-dialog, .ui-dialog-buttonpane").css({"font-size":"12px","z-index":1E6});return!1},printEvents:function(){if(a("#b_search_cal").hasClass("ui-state-active")){var b=a("#common_search").val(),d="simple";if(""==b){var d="complex",c=a("#search_cal");if(c){c=c.jqFilter("filterData");if(!c.rules.length)return!1;try{b=xmlJsonClass.toJson(c,"","",!1)}catch(e){try{b=
JSON.stringify(c)}catch(f){}}}}window.location=a.jqschedule.calendarurl+"?oper=printEvents&stype="+d+"&search=true&svalue="+b}else d=jQuery(a.jqschedule.calendarid).fullCalendar("getView"),b=d.start.getTime()/1E3,d=d.end.getTime()/1E3,window.location=a.jqschedule.calendarurl+"?oper=printEvents&start="+b+"&end="+d;return!1},exportEvents:function(){if(a("#b_search_cal").hasClass("ui-state-active")){var b=a("#common_search").val(),d="simple";if(""==b){var d="complex",c=a("#search_cal");if(c){c=c.jqFilter("filterData");
if(!c.rules.length)return!1;try{b=xmlJsonClass.toJson(c,"","",!1)}catch(e){try{b=JSON.stringify(c)}catch(f){}}}}window.location=a.jqschedule.calendarurl+"?oper=exportEvents&stype="+d+"&search=true&svalue="+b}else d=jQuery(a.jqschedule.calendarid).fullCalendar("getView"),b=d.start.getTime()/1E3,d=d.end.getTime()/1E3,window.location=a.jqschedule.calendarurl+"?oper=exportEvents&start="+b+"&end="+d;return!1},showSearch:function(){a("#common_search").val()&&(a("#common_search").val(""),a("#b_common_search").trigger("click"));
a(this).addClass("ui-state-active");a(".fc-view-agendaWeek, .fc-view-agendaDay, .fc-view-basicDay, .fc-view-basickWeek, .fc-view-month, .fc-view-year").hide();a(".fc-view-search").show();a("#common_search").focus()},hideSearch:function(){a(this).removeClass("ui-state-active");var b=a(a.jqschedule.calendarid).fullCalendar("getView").name;a(".fc-view-search").hide();a(".fc-view-"+b).show()},_filSearchTable:function(b,d){a(d).empty();if(b&&b.length){a(".fnd-results").html(b.length);var c="";a.each(b,
function(){var b=a.fullCalendar.parseDate(this.start),d=a.fullCalendar.parseDate(this.end),g=a.fullCalendar.formatDate(b,"HH:mm"),k=a.fullCalendar.formatDate(d,"HH:mm"),g=this.allDay?"all day":g+" - "+k,b=a.fullCalendar.formatDate(b,"ddd  dd MMM yyyy"),d=a.fullCalendar.formatDate(d,"ddd  dd MMM yyyy");b!=d&&(g+=" "+d);c+="<tr id='"+this.id+"'><th class='ui-event-cell ui-widget-content'><a href=\"javascript:jQuery.jqschedule.gotoDayEventView('"+this.start+"');\">"+b+"</a></th><td class='ui-event-time ui-widget-content'>"+
g+"</td><td class='ui-event-title ui-widget-content'><a href=\"javascript:jQuery.jqschedule.editFromSearch('"+this.id+"');\" class='' style='border: 0px none;text-decoration:  underline;'>"+this.title+"</a></td>";c+="<td class='source' style='display:none;'>";c+=this.id+"~`"+this.title+"~`"+this.start+"~`"+this.end+"~`"+this.description+"~`"+this.location+"~`"+this.className+"~`"+this.access+"~`"+this.allDay+"~`"+this.user_id;c+="</td>";c+="</tr>"});a(d).append(c)}},doSimpleSearch:function(){var b=
a("#common_search").val();b?a.ajax({url:a.jqschedule.calendarurl,data:{search:!0,stype:"simple",svalue:b,oper:"getEvent"},dataType:"json",type:"POST",success:function(b,c){a.jqschedule._filSearchTable(b,"#search_table")}}):(a(".fnd-results").html(""),a("#search_table").empty())},buildLocalSearch:function(){var b,d;a("label",a.jqschedule.eventid).each(function(c){b={};b.name=a(this).attr("for");b.label=a(this).html();"categories"==b.name||"access"==b.name?(b.inputtype="select",d={},a("#"+b.name+" option",
a.jqschedule.eventid).each(function(){d[a(this).val()]=a(this).text()}),b.searchoptions={value:d}):"all_day"==b.name?(b.inputtype="select",d={1:"Yes",0:"No"},b.searchoptions={value:d}):"start"==b.name||"end"==b.name?(b.searchtype="date",b.searchoptions={size:20,sopt:["eq","gt","ge","lt","le"],dataInit:function(b){a(b).datetimepicker()}}):b.searchoptions={size:20};a.jqschedule.searchCols[c]=b})},advancedSearchDlg:function(){a("#search_cal").jqFilter({columns:a.jqschedule.searchCols,filter:{groupOp:"AND",
rules:[{field:a.jqschedule.searchCols[0].name,op:"eq",data:""}]},_gridsopt:a.jqschedule.searchOpers});a("#search_cal").dialog({modal:!0,width:"auto",autoOpen:!1,title:a.jqschedule.locales.searchCaption,close:function(){},buttons:[{text:a.jqschedule.locales.bSearch,click:function(){var b=a("#search_cal"),d,c=b.jqFilter("filterData");if(c.rules.length){try{d=xmlJsonClass.toJson(c,"","",!1)}catch(e){try{d=JSON.stringify(c)}catch(f){}}d&&a.ajax({url:a.jqschedule.calendarurl,data:{search:!0,stype:"complex",
svalue:d,oper:"getEvent"},dataType:"json",type:"POST",success:function(b,c){a.jqschedule._filSearchTable(b,"#search_table")}});b.dialog("close")}}},{text:a.jqschedule.locales.bClose,click:function(){a("#search_cal").dialog("close")}}]});a(".ui-dialog, .ui-dialog-buttonpane").css({"font-size":"12px","z-index":1E6})},editFromSearch:function(b){var d=a("tr#"+b+" td.source").html().split("~`"),c={};a.each("id title start end description location className access allDay user_id".split(" "),function(a){if("start"==
this||"end"==this)d[a]=new Date(1E3*parseFloat(d[a]));"allDay"==this&&(d[a]="1"==d[a]?!0:!1);c[this]=d[a]});a.jqschedule.eventViewDialog(c)},openDaySearchDlg:function(b,d,c){var e=b.getTime()/1E3;b.setHours(23);b.setMinutes(23);var f=b.getTime()/1E3,g=a("#day_dialog");g.dialog({modal:!0,width:450,close:function(){g.dialog("destroy");g.hide();g=null},open:function(b,c){a("#day_table").empty();a.ajax({url:a.jqschedule.calendarurl,data:{oper:"getEvent",start:e,end:f},dataType:"json",type:"POST",success:function(b,
c){a.jqschedule._filSearchTable(b,"#day_table")}})},buttons:[{text:a.jqschedule.locales.bClose,click:function(){g.dialog("close")}}]}).show();a(".ui-dialog, .ui-dialog-buttonpane").css({"font-size":"12px","z-index":1E6})},eventsFunc:function(b,d,c){a.ajax({url:a.jqschedule.calendarurl,dataType:"json",type:"POST",data:{oper:"getEvent",start:b.getTime()/1E3,end:d.getTime()/1E3},success:function(a,b){c(a)}})},processScript:function(){a("#datepicker").datepicker({dateFormat:"yy-mm-dd",onSelect:function(b,
d){var c=b.split("-");a(a.jqschedule.calendarid).fullCalendar("gotoDate",parseInt(c[0],10),parseInt(c[1],10)-1,parseInt(c[2],10))}});a("#start, #end",a.jqschedule.eventid).datepicker();a("#all_day",a.jqschedule.eventid).click(function(){this.checked?a("#endtime, #starttime",a.jqschedule.eventid).val("00:00").hide():a("#endtime, #starttime",a.jqschedule.eventid).show()});a(".custbutton").height(a("table.fc-header").height());a("#b_user_change").click(jQuery.jqschedule.changeCalendarUser);a("#b_export_ical").click(jQuery.jqschedule.exportEvents);
a("#b_print_cal").click(jQuery.jqschedule.printEvents);a(".fc-content",a.jqschedule.calendarid).append(a(".fc-view-search"));a("#b_search_cal").toggleClick(jQuery.jqschedule.showSearch,jQuery.jqschedule.hideSearch);a("#b_common_search").click(jQuery.jqschedule.doSimpleSearch);a("#b_adv_search").click(function(){a("#search_cal").dialog("open");return!1});a(".jq-button").hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});a.jqschedule.buildLocalSearch();
a.jqschedule.advancedSearchDlg()}}})(jQuery);
